...
class Player {
  ...
  strike (player, enemy, attackDmg) {
    ...
    return `${player.name} damages ${enemy.name}'s health by ${damageAmount} points`;
  ...
  heal (player) {
    ...
    return `${player.name} heals their health by ${healAmount} points`;
  }
}
...
let player1 = new Player('Kushal', 100, 10);
let player2 = new Player('Felix', 100, 10);
